...
<div class="card p-2 content">
    <div class="flex flex-wrap">
        ...
        <a href="<?php echo e(cp_route('collections.blueprints.index', $collection->handle())); ?>" class="w-full lg:w-1/2 p-2 flex items-start hover:bg-grey-20 rounded-md group">
            <div class="h-8 w-8 mr-2 text-grey-80">
                <?php echo Statamic::svg('blueprint') ?>
            </div>
            <div class="flex-1 mb-2 md:mb-0 md:mr-3">
                <h3 class="mb-1 text-blue"><?php echo e(__('Configure Blueprints')); ?> &rarr;</h3>
        ...
        <a href="<?php echo e(cp_route('collections.scaffold', $collection->handle())); ?>" class="w-full lg:w-1/2 p-2 flex items-start hover:bg-grey-20 rounded-md group">
            ...
            <div class="flex-1 mb-2 md:mb-0 md:mr-3">
                <h3 class="mb-1 text-blue"><?php echo e(__('Scaffold Views')); ?> &rarr;</h3>
...
<?php echo $__env->make('statamic::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/elias/Sites/Github/stegreif/vendor/statamic/cms/src/Providers/../../resources/views/collections/empty.blade.php ENDPATH**/ ?>