    ...
    <div class="card p-0">
        <div class="p-2">
            <div class="flex justify-between items-center">
                ...
                <div class="flex">
                    <form method="POST" action="<?php echo e(cp_route('utilities.cache.warm', 'stache')); ?>" class="mr-1">
                        <?php echo csrf_field(); ?>
        ...
        <div class="p-2 bg-grey-20 border-t">
            ...
            <div class="text-sm text-grey flex">
                <div class="mr-2 badge-pill-sm bg-white border"><span class="text-grey-80 font-medium"><?php echo e(__('Strategy')); ?>:</span> <?php echo e($static['strategy']); ?></div>
                <?php if($static['enabled']): ?>
                    <div class="mr-2 badge-pill-sm bg-white border"><span class="text-grey-80 font-medium"><?php echo e(__('Pages')); ?>:</span> <?php echo e($static['count']); ?></div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="p-2 border-t bg-grey-20 rounded-b">
            ...
            <div class="text-sm text-grey flex">
                <div class="mr-2 badge-pill-sm bg-white border"><span class="text-grey-80 font-medium"><?php echo e(__('Cached images')); ?>:</span> <?php echo e($images['count']); ?></div>
                <div class="mr-2 badge-pill-sm bg-white border"><span class="text-grey-80 font-medium"><?php echo e(__('Size')); ?>:</span> <?php echo e($images['size']); ?></div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('statamic::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/elias/Sites/Github/stegreif/vendor/statamic/cms/src/Providers/../../resources/views/utilities/cache.blade.php ENDPATH**/ ?>