    ...
    <nav class="nav-main" v-cloak>
        <div class="nav-main-inner">
            <?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
                <ul class="nav-section-<?php echo e(Statamic\Support\Str::slug($section)); ?>">
...
<?php /**PATH /Users/elias/Sites/Github/stegreif/vendor/statamic/cms/src/Providers/../../resources/views/partials/nav-main.blade.php ENDPATH**/ ?>